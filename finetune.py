...
def main(args):
    ...
    load_previous_models(args,trainer)
...
def load_previous_models(args, trainer):
    """Load a checkpoint and replay dataloader to match."""
    os.makedirs(args.save_dir, exist_ok=True)
    ...
    if os.path.isfile(enc_checkpoint_path) and os.path.isfile(dec_checkpoint_path):
        trainer.load_mix_checkpoints(enc_checkpoint_path,
                                     dec_checkpoint_path,
                                     args.enckey,
                                     args.deckey,
                                     args.newkey,
...
if __name__ == '__main__':
    parser = options.get_finetune_parser()
