...
def collate(
    ...
    src_lengths = torch.LongTensor([s['source'][1].size(1) for s in samples])
...
class SpeechPairDataset(FairseqDataset):
    """
    ...
    def __init__(
        ...
        self.src_sizes = np.array(tgt_sizes) if tgt_sizes is not None else None
