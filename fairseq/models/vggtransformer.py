...
from fairseq.data.speech_data_utils import lengths_to_encoder_padding_mask
from fairseq.models.transformer import TransformerDecoderLayer, TransformerEncoderLayer
from . import FairseqModel
...
class VGGTransformerModel(FairseqModel):
    ...
    an array of tuples for the decoder 1-D convolution config
        ...
        parser.add_argument('--relu-dropout', type=float, metavar='D',default=0.1,
...
class VGGTransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths, **kwargs):
        ...
        """
        src_tokens = src_tokens.permute(0,2,1)
