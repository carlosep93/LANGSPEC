...
mkdir ../vectors-elora/multilingual/decodings-layer${LAYER}/
...
CUDA_VISIBLE_DEVICES="" stdbuf -i0 -e0 -o0 python interactive_decoder_layer.py  $DEST_DIR --path $CP_DIR/$CP  --beam 1 --batch-size 1 --source-lang $SRC --target-lang $TGT --task translation --output-file ../vectors-elora/multilingual/decodings-layer${LAYER}/decodings-fren-${LAYER}.json --n-points 3000 --layer $LAYER <  tmp/source.bpe

sed 's/^/<2en> /'  ~/europarl/en-es/test.es > tmp/source.raw

subword-nmt apply-bpe -c ../fairseq/data-bin/multi-europarl/corpus.tc.shuf.codes.src  < tmp/source.raw >  tmp/source.bpe

CUDA_VISIBLE_DEVICES="" stdbuf -i0 -e0 -o0 python interactive_decoder_layer.py $DEST_DIR --path $CP_DIR/$CP   --beam 1 --batch-size 1 --source-lang $SRC --target-lang $TGT --task translation --output-file ../vectors-elora/multilingual/decodings-layer${LAYER}/decodings-esen-${LAYER}.json --n-points 3000 --layer $LAYER <  tmp/source.bpe

sed 's/^/<2es> /'  ~/europarl/en-fr/test.en > tmp/source.raw

subword-nmt apply-bpe -c ../fairseq/data-bin/multi-europarl/corpus.tc.shuf.codes.src  < tmp/source.raw >  tmp/source.bpe

CUDA_VISIBLE_DEVICES="" stdbuf -i0 -e0 -o0 python interactive_decoder_layer.py $DEST_DIR --path $CP_DIR/$CP   --beam 1 --batch-size 1 --source-lang $SRC --target-lang $TGT  --task translation --output-file ../vectors-elora/multilingual/decodings-layer${LAYER}/decodings-enes-${LAYER}.json --n-points 3000 --layer $LAYER <  tmp/source.bpe
...
CUDA_VISIBLE_DEVICES="" stdbuf -i0 -e0 -o0 python interactive_decoder_layer.py $DEST_DIR --path $CP_DIR/$CP   --beam 1 --batch-size 1 --source-lang $SRC --target-lang $TGT --task translation --output-file ../vectors-elora/multilingual/decodings-layer${LAYER}/decodings-eses-${LAYER}.json --n-points 3000 --layer $LAYER <  tmp/source.bpe

sed 's/^/<2en> /'  ~/europarl/en-es/test.en > tmp/source.raw

subword-nmt apply-bpe -c ../fairseq/data-bin/multi-europarl/corpus.tc.shuf.codes.src  < tmp/source.raw >  tmp/source.bpe

CUDA_VISIBLE_DEVICES="" stdbuf -i0 -e0 -o0 python interactive_decoder_layer.py $DEST_DIR --path $CP_DIR/$CP   --beam 1 --batch-size 1 --source-lang $SRC --target-lang $TGT --task translation --output-file ../vectors-elora/multilingual/decodings-layer${LAYER}/decodings-enen-${LAYER}.json --n-points 3000 --layer $LAYER <  tmp/source.bpe
