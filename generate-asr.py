...
from fairseq.speech_sequence_generator import SpeechSequenceGenerator
...
def main(args):
    ...
    itr = task.get_batch_iterator(
        ...
        max_positions=models[0].decoder.max_positions(),
    ...
    if args.score_reference:
        ...
        translator = SpeechSequenceGenerator(
    ...
    with progress_bar.build_progress_bar(args, itr) as t:
        ...
        wps_meter = TimeMeter()
        for sample_id, target_tokens, hypos in translations:
